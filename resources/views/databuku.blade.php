            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <div class="demo-inline-spacing d-flex justify-content-end mx-2">
                  <a class="btn btn-primary" href="{{url('tambahbuku')}}"  role="button">Tambah</a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$inem->penulis}}</td>
                            <td>{{$inem->penerbit}}</td>
                            <td>{{$inem->tahun_terbit}}</td>
                            <td>{{$inem->stok}}</td>
                            <td>{{$inem->harga_pokok}}</td>
                            <td>{{$inem->harga_jual}}</td>
                            <td>{{$inem->diskon}}</td>
                            <td>
                                <div class="dropdown">
                                  <button
                                  ...
                                  <div class="dropdown-menu">
                                    <a href="{{url('editbuku/'.$inem->id_buku)}}" class="dropdown-item"
                                      ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                    >
                                    <a href="{{url('hapusbuku/'.$inem->id_buku)}}" class="dropdown-item"
